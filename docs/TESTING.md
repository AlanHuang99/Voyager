...
An opt-in Docker test verifies that an SSH key generated by Voyager authenticates against a real OpenSSH-backed SFTP container, then uploads and downloads a probe file:
